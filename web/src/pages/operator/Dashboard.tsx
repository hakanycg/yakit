...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      {/* Odeme yontemi dagilimi buradan KALDIRILDI: kiosk'ta odeme yontemi secimi yok,
          herkes kartla oduyor - grafik tek dilimden ve olu demo verisinden ("sanal kart")
          ibaretti. Kanal kirilimi gun sonu mutabakatinda duruyor, orada bir isi var:
          hangi kanaldan ne kadar para bekledigimizi soyler. */}
      {canSeeRevenue && (
