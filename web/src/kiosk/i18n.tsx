...
const DICTS: Record<KioskLang, Dict> = {
  tr: {
    ...
    "help.sentBody": "İstasyon sorumlusu bilgilendirildi. Lütfen bir süre bekleyin; acil bir durum varsa 112'yi arayın.",
  ...
  en: {
    ...
    "help.sentBody": "The station supervisor has been notified. Please wait a moment; in an emergency call 112.",
  ...
  ru: {
    ...
    "help.sentBody": "Ответственный по станции уведомлён. Пожалуйста, подождите; в экстренной ситуации звоните 112.",
  ...
  de: {
    ...
    "help.sentBody": "Die Stationsleitung wurde benachrichtigt. Bitte warten Sie kurz; im Notfall wählen Sie 112.",
  ...
  ar: {
    ...
    "help.sentBody": "تم إبلاغ مسؤول المحطة. يرجى الانتظار قليلاً؛ في حالة الطوارئ اتصل بـ 112.",
